...
tetramer = 'C:/Users/User/SEProm-master/train_data/tss_edited.txt'
paramVals = 'C:/Users/User/SEProm-master/train_data/new_tetramer.xlsx'
tetramer_cds = 'C:/Users/User/SEProm-master/train_data/cds_edited.txt'
...
#df_to_look = pd.DataFrame(tetra_seq_map)
...
a = [0 for i in range(973)]
b = [0 for i in range(973)]
c = [0 for i in range(973)]
d = [0 for i in range(973)]
e = [0 for i in range(973)]
f = [0 for i in range(973)]
g = [0 for i in range(973)]
h = [0 for i in range(973)]
i = [0 for z in range(973)]
j = [0 for i in range(973)]
k = [0 for i in range(973)]
l = [0 for i in range(973)]
m = [0 for i in range(973)]
n = [0 for i in range(973)]
o = [0 for i in range(973)]
p = [0 for i in range(973)]
q = [0 for i in range(973)]
r = [0 for i in range(973)]


a_cds = [0 for i in range(973)]
b_cds = [0 for i in range(973)]
c_cds = [0 for i in range(973)]
d_cds = [0 for i in range(973)]
e_cds = [0 for i in range(973)]
f_cds = [0 for i in range(973)]
g_cds = [0 for i in range(973)]
h_cds = [0 for i in range(973)]
i_cds = [0 for z in range(973)]
j_cds = [0 for i in range(973)]
k_cds = [0 for i in range(973)]
...
r_cds = [0 for i in range(973)]

counter_nine=0
for z in range(len(sequence_map_tss)):
    if len(tetra_seq_map['normalized_params_map'][z]['a'])!= 974:
        counter_nine=1
        print(z)
if counter_nine ==0:
    print("all_ok_TSS")
...
for z in range(len(sequence_map_cds)):
    if len(tetra_cds_seq_map['normalized_params_map'][z]['a'])!= 973:
        counter_nine_cds=1
        print(z)
if counter_nine_cds ==0:
    print("all_ok_CDS")
...
tss_df.to_csv("tss_df_combined_tetra.csv")
cds_df.to_csv("cds_df_combined_tetra.csv")
